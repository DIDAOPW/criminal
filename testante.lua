...
local Tabs = {
    ...
    Aimbot = Window:AddTab({ Title = "Aimbot+ESP", Icon = "chevrons-left-right" }),
...
do
    Fluent:Notify({
        ...
        Content = "Obrigado por usar minha script <3",
        SubContent = "yFriderichs", -- Optional
...
--paragrafos
    ...
    Tabs.Aimbot:AddParagraph({
        Title = "Aviso",
        Content = "Aimbot Simples não possui menu, mas é util para mobiles."
    })
